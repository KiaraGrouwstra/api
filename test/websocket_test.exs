...
#
#     transport :websocket, Phoenix.Transports.WebSocket, check_origin: ["//example.com"], timeout: 200
#
...
#     assert_receive %Message{event: "phx_reply", payload: %{"response" => %{}, "status" => "ok"}, ref: "1", topic: "rooms:admin-lobby"}
#   end
#
